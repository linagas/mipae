                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a  href="<?php echo base_url();?>asignacion/buscar_asignacion"  target="MiIframe"><i class="fa fa-fw fa-search fa-2x"></i> Buscar Escuela</a>
                                </li>
                                <li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="<?php echo base_url();?>asistencia/buscar_asistencia" rel="stylesheet" target="MiIframe"><i class="fa fa-fw fa-search fa-2x"></i> Buscar Asistencia</a>
                                </li>
                                 <li>
                       ...
                       <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="<?php echo base_url();?>madre/buscar_madre" rel="stylesheet" target="MiIframe"><i class="fa fa-fw fa-search fa-2x"></i> Buscar Madre</a>
                                </li>
                                 <li>
                                    <a  href="<?php echo base_url();?>madre/get_madre"  target="MiIframe"><i class="fa fa-fw fa-list fa-2x"></i> Lista de Madres</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                       </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                 ...
                                 <li>
                                    <a href="<?php echo base_url();?>incidencia_escuela/buscar_incidencia_escuela" rel="stylesheet" target="MiIframe"><i class="fa fa-fw fa-search fa-2x"></i> Buscar</a>
                                </li>
                                 <li>
                         ...
                         <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                 ...
                                 <li>
                                    <a href="<?php echo base_url();?>nota/buscar_nota" rel="stylesheet" target="MiIframe"><i class="fa fa-fw fa-search fa-2x"></i> Buscar</a>
                                </li>
                                 <li>
                                    <a  href="<?php echo base_url();?>nota/get_nota_entrega"  target="MiIframe"><i class="fa fa-fw fa-list fa-2x"></i> Lista de Notas de Entrega</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        ...
                        <li>
                            <a href="http://localhost/escuela_e/" target="MiIframe"><i class="fa fa-print fa-2x"></i></i>Reportes y Estadisticas!!<span class="fa arrow"></span></a>
