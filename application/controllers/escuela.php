...
class Escuela extends CI_Controller{
    ...
    function insertar_escuelas() {
        ...
        if ($process) {
            ...
            $c_codigo=  $this->escuela_model->get_codigo_escuelas($codigo_escuela);
                if($c_codigo){
                    $data['result']='Disculpe este codigo ya esta asignado a una escuela';
                    
                     $this->parser->parse('backend/escuelas/insertar_escuela', $data);
                     ?>
                    <script>
                             alert("Su registro no ha sido insertado el codigo ya existe");
                    </script>
                    <?php
                }else{
            ...
            $escuelaInsertado = $this->escuela_model->insert_escuela($values);
                    ...
                    $id_escuela = $this->input->post($escuelaInsertado);
                ...
                $data['result']="Ocurrio un error con sus datos de escuela";
                $this->parser->parse('backend/escuelas/insertar_escuela', $data);
                }
            }else {
            $data['result']="";
...
//                    print_r($data);
    ...
    public function buscar_escuela_ajax(){
         $codigo = $this->input->post('codigo');
             $madre = $this->escuela_model->get_codigo_escuelas($codigo);
